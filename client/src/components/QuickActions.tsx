    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      >
        <div className="p-2.5 bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 group-hover:from-blue-600 group-hover:via-blue-700 group-hover:to-blue-800 rounded-lg mb-2 shadow-2xl group-hover:shadow-inner group-hover:shadow-blue-800/30 transition-all duration-300 relative overflow-hidden group-hover:scale-95">
          ...
          <Upload className="h-4 w-4 text-white group-hover:text-blue-200 drop-shadow-lg relative z-10 transition-colors duration-300" aria-hidden="true" />
        </div>
      ...
      >
        <div className="p-2.5 bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 group-hover:from-blue-600 group-hover:via-blue-700 group-hover:to-blue-800 rounded-lg mb-2 shadow-2xl group-hover:shadow-inner group-hover:shadow-blue-800/30 transition-all duration-300 relative overflow-hidden group-hover:scale-95">
          <div className="absolute inset-0 bg-gradient-to-r from-white/25 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          <ClipboardCheck className="h-4 w-4 text-white group-hover:text-blue-200 drop-shadow-lg relative z-10 transition-colors duration-300" aria-hidden="true" />
        </div>
      ...
      >
        <div className="p-2.5 bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 group-hover:from-blue-600 group-hover:via-blue-700 group-hover:to-blue-800 rounded-lg mb-2 shadow-2xl group-hover:shadow-inner group-hover:shadow-blue-800/30 transition-all duration-300 relative overflow-hidden group-hover:scale-95">
          <div className="absolute inset-0 bg-gradient-to-r from-white/25 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          <Plus className="h-4 w-4 text-white group-hover:text-blue-200 drop-shadow-lg relative z-10 transition-colors duration-300" aria-hidden="true" />
        </div>
      ...
      >
        <div className="p-2.5 bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 group-hover:from-blue-600 group-hover:via-blue-700 group-hover:to-blue-800 rounded-lg mb-2 shadow-2xl group-hover:shadow-inner group-hover:shadow-blue-800/30 transition-all duration-300 relative overflow-hidden group-hover:scale-95">
          <div className="absolute inset-0 bg-gradient-to-r from-white/25 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          <HelpCircle className="h-4 w-4 text-white group-hover:text-blue-200 drop-shadow-lg relative z-10 transition-colors duration-300" aria-hidden="true" />
        </div>
