      ...
      <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-10">
        ...
        <section className="mb-8 sm:mb-12">
          ...
          <div className="grid gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <button 
              className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-inner hover:from-gray-50 hover:to-gray-100 transition-all duration-300 hover:translate-y-1 hover:scale-[0.98] group text-center" 
            ...
            >
              <div className="w-12 h-12 bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 group-hover:from-blue-600 group-hover:via-blue-700 group-hover:to-blue-800 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-2xl group-hover:shadow-inner group-hover:shadow-blue-800/30 transition-all duration-300 relative overflow-hidden group-hover:scale-95">
                ...
                <ClipboardCheck className="h-6 w-6 text-white group-hover:text-blue-200 drop-shadow-lg relative z-10 transition-colors duration-300" />
              </div>
            ...
            >
              <div className="w-12 h-12 bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 group-hover:from-blue-600 group-hover:via-blue-700 group-hover:to-blue-800 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-2xl group-hover:shadow-inner group-hover:shadow-blue-800/30 transition-all duration-300 relative overflow-hidden group-hover:scale-95">
                <div className="absolute inset-0 bg-gradient-to-r from-white/25 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <Upload className="h-6 w-6 text-white group-hover:text-blue-200 drop-shadow-lg relative z-10 transition-colors duration-300" />
              </div>
            ...
            >
              <div className="w-12 h-12 bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 group-hover:from-blue-600 group-hover:via-blue-700 group-hover:to-blue-800 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-2xl group-hover:shadow-inner group-hover:shadow-blue-800/30 transition-all duration-300 relative overflow-hidden group-hover:scale-95">
                <div className="absolute inset-0 bg-gradient-to-r from-white/25 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <FilePlus className="h-6 w-6 text-white group-hover:text-blue-200 drop-shadow-lg relative z-10 transition-colors duration-300" />
              </div>
            ...
            >
              <div className="w-12 h-12 bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 group-hover:from-blue-600 group-hover:via-blue-700 group-hover:to-blue-800 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-2xl group-hover:shadow-inner group-hover:shadow-blue-800/30 transition-all duration-300 relative overflow-hidden group-hover:scale-95">
                <div className="absolute inset-0 bg-gradient-to-r from-white/25 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <HelpCircle className="h-6 w-6 text-white group-hover:text-blue-200 drop-shadow-lg relative z-10 transition-colors duration-300" />
              </div>
